...
public class Promises {
    ...
    public static <T> IterablePromiseFactory<T> iterablePromiseFactory(Iterable<T> iterable) {
        return new IterablePromiseFactory<T>(iterable);
    }

    public static <T, R> Promise<R> map(final Promise<T> promise, final F1<? super T, ? extends R> f) {
